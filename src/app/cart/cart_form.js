...
export const CartForm = () => {
  ...
  const allDeliveryTypes = [
    {"value":"Directo en Planta", "label": "Directo en Planta"},
                ...
                <ul className="ul_li_block clearfix">
                  ...
                  (<div className="contact3_wrap" style={{marginTop:"10px",border:"0"}}>
                    ...
                    <input
                      ...
                      /> 
                      <label style={{marginLeft:"10px",fontWeight: "800"}} htmlFor="agree"> Acepto los <a href="/terminos" target="_blank" style={{color:"#25BC6C"}}>términos y condiciones</a></label>
